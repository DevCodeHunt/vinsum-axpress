...
import TrackShipmentModel from './TrackShipmentModel'
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      if (values.docketNumber !== "") {
        setLoading(true)
      axios.get(`https://testwebsiteapi.vinsumaxpress.com/api/DocketTracking?docketno=${values.docketNumber}`)
      .then(res => {
  ...
  return (
    ...
    >
      <div className="wrapper text-white absolute inset-0 z-10 flex flex-col justify-center pt-56">
        ...
        {/* {docketData != null ? <TrackShipmentModel data = {docketData} /> : <div />} */}
        ...
        <div className="py-10">
          <motion.div
            ...
            className="min-[576px]:w-96 border shadow  rounded-2xl p-4 space-y-10 bg-white text-black shadow isolate bg-white/20 shadow-lg ring-1 ring-black/5"
          >
            <div className="flex items-center justify-between gap-3">
              ...
              <span className="text-sm font-medium text-white">Shipment Rate</span>
            </div>
